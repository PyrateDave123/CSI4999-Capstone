...
const react_pkg_json_1 = __importDefault(require("./react-pkg.json"));
...
describe('OktaDev Schematics: React', () => {
    ...
    it('works', () => {
        ...
        // Add package.json
        tree.create('/package.json', JSON.stringify(react_pkg_json_1.default));
        const runner = new testing_1.SchematicTestRunner('schematics', collectionPath);
...
//# sourceMappingURL=react_spec.js.map