(function (global, factory) {
    ...
    var AngularFireMessaging = (function () {
        function AngularFireMessaging(options, nameOrConfig, platformId, zone) {
            ...
            this.messaging = requireMessaging.pipe(operators.map(function () { return fire._firebaseAppFactory(options, zone, nameOrConfig); }), operators.map(function (app) { return app.messaging(); }), fire.runOutsideAngular(zone));
