...
var AngularFireMessaging = (function () {
    function AngularFireMessaging(options, nameOrConfig, platformId, zone) {
        ...
        this.messaging = requireMessaging.pipe(map(function () { return _firebaseAppFactory(options, zone, nameOrConfig); }), map(function (app) { return app.messaging(); }), runOutsideAngular(zone));
