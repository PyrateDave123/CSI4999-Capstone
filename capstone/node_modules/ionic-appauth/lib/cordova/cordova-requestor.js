...
var CordovaRequestor = /** @class */ (function (_super) {
    __extends(CordovaRequestor, _super);
    function CordovaRequestor() {
        var _this = this;
        index_1.CordovaDocument.ready(function () { return http_1.HTTP.setDataSerializer('utf8'); });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!settings.method)
                            settings.method = "GET";
                        return [4 /*yield*/, index_1.CordovaDocument.ready()];
                    case 1:
                        _a.sent();
