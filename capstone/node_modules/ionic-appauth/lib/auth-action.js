...
(function (AuthActions) {
    ...
    AuthActions["AuthSignInSuccess"] = "Auto Sign In Success";
...
var AuthActionBuilder = /** @class */ (function () {
    ...
    AuthActionBuilder.SignOutFailed = function () {
        return {
    ...
    AuthActionBuilder.RefreshFailed = function () {
        return {
    ...
    AuthActionBuilder.SignInFailed = function () {
        return {
    ...
    AuthActionBuilder.AutoSignInFailed = function () {
        return {
            action: AuthActions.AutoSignInFailed,
        };
    };
