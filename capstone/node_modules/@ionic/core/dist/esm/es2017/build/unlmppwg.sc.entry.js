...
class Datetime {
    ...
    generatePickerOptions() {
        const pickerOptions = Object.assign({}, this.pickerOptions, { mode: this.mode, columns: this.generateColumns() });
