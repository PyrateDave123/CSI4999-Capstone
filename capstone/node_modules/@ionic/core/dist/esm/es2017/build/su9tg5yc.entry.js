...
class Select {
    ...
    async openPopover(ev) {
        ...
        const popoverOpts = Object.assign({}, interfaceOptions, { mode: this.mode, component: 'ion-select-popover', cssClass: ['select-popover', interfaceOptions.cssClass], event: ev, componentProps: {
    ...
    async openActionSheet() {
        ...
        const interfaceOptions = this.interfaceOptions;
        const actionSheetOpts = Object.assign({}, interfaceOptions, { mode: this.mode, buttons: actionSheetButtons, cssClass: ['select-action-sheet', interfaceOptions.cssClass] });
    ...
    async openAlert() {
        ...
        const alertOpts = Object.assign({}, interfaceOptions, { mode: this.mode, header: interfaceOptions.header ? interfaceOptions.header : labelText, inputs: this.childOpts.map(o => {
                return {
                    type: inputType,
                    label: o.textContent,
                    value: o.value,
