...
const core = require('./core-472ad70e.js');
...
const Spinner = class {
    ...
    render() {
        ...
        return (core.h(core.Host, { class: Object.assign({}, theme.createColorClasses(self.color), { [mode]: true, [`spinner-${spinnerName}`]: true, 'spinner-paused': !!self.paused || config.config.getBoolean('_testing') }), role: "progressbar", style: spinner.elmDuration ? { animationDuration: duration + 'ms' } : {} }, svgs));
    }
