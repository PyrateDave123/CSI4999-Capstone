...
const index = require('./index-0f2622c1.js');
...
const Nav = class {
    ...
    async componentDidLoad() {
        this.rootChanged();
        this.gesture = (await new Promise(function (resolve) { resolve(require('./swipe-back-76782bf3.js')); })).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
