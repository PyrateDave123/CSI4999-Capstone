...
var EndSessionPageModule = /** @class */ (function () {
    function EndSessionPageModule() {
    }
...
var EndSessionPage = /** @class */ (function () {
    function EndSessionPage(authService, navCtrl) {
        this.authService = authService;
        this.navCtrl = navCtrl;
    }
    EndSessionPage.prototype.ngOnInit = function () {
        this.authService.EndSessionCallBack();
        this.navCtrl.navigateRoot('login');
    };
    EndSessionPage.ctorParameters = function () { return [
...
//# sourceMappingURL=auth-implicit-end-session-end-session-module-es5.js.map