...
var Tab1Page = /** @class */ (function () {
    function Tab1Page(navCtrl, authService) {
        this.navCtrl = navCtrl;
        this.authService = authService;
    }
    Tab1Page.prototype.ngOnInit = function () {
        var _this = this;
        this.authService.authObservable.subscribe(function (action) {
            _this.action = action;
    ...
    Tab1Page.prototype.signOut = function () {
        this.authService.signOut();
    };
    Tab1Page.prototype.signIn = function () {
        this.authService.signIn().catch(function (error) { return console.error("Sign in error: " + error); });
    };
    Tab1Page.prototype.getUserInfo = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.authService.getUserInfo()];
                    case 1:
                        _a.userInfo = _b.sent();
                        return [2 /*return*/];
                }
